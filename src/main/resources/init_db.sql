...
INSERT INTO mouvements(type, quantite, date_mouvement, motif, produit_id, utilisateur_id) VALUES
                                                                                              ('ENTREE', 20, DATE_SUB(NOW(), INTERVAL 2 MONTH), 'Réapprovisionnement initial', 1, 1),
                                                                                              ('ENTREE', 10, DATE_SUB(NOW(), INTERVAL 2 MONTH), 'Réapprovisionnement initial', 2, 1),
                                                                                              ('SORTIE', 5, DATE_SUB(NOW(), INTERVAL 1 MONTH), 'Vente client', 1, 2),
                                                                                              ('SORTIE', 3, DATE_SUB(NOW(), INTERVAL 1 MONTH), 'Vente client', 2, 2),
